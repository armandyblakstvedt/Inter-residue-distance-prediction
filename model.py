...
class Model(nn.Module):
    def __init__(self, input_channels):
        ...
        # Projection for first residual block: input -> after conv2 (128 channels)
        self.res1 = nn.Conv2d(in_channels=input_channels, out_channels=128, kernel_size=1, stride=1)

        self.conv3 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1)
        self.bn3 = nn.BatchNorm2d(128)
        self.conv4 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1)
        self.bn4 = nn.BatchNorm2d(256)
        # Projection for second residual block: 128 -> 256 channels
        self.res2 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=1, stride=1)
        ...
        # Projection for third residual block: 256 -> 32 channels
        self.res3 = nn.Conv2d(in_channels=256, out_channels=32, kernel_size=1, stride=1)
